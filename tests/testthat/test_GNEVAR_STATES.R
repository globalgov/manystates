...
test_that("Columns are not in date, POSIXct or POSIXlt class", {
  expect_false(any(lubridate::is.Date(states[["GNEVAR_STATES"]])))
  expect_false(any(lubridate::is.POSIXct(states[["GNEVAR_STATES"]])))
  expect_false(any(lubridate::is.POSIXlt(states[["GNEVAR_STATES"]])))
})
...
test_that("labels are standardised", {
  expect_false(any(grepl("U\\.S\\.", states[["GNEVAR_STATES"]])))
  expect_false(any(grepl("U\\.K\\.", states[["GNEVAR_STATES"]])))
  expect_false(any(grepl("!", states[["GNEVAR_STATES"]])))
  expect_false(any(grepl("NANA.", states[["GNEVAR_STATES"]])))
})
