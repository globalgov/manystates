...
test_that("Columns with dates are standardized", {
  expect_equal(class(regimes[["FreedomHouse2"]]$Year), "mdate")
...
test_that("object has the correct variables", {
  pointblank::expect_col_exists(regimes[["FreedomHouse2"]],
                                pointblank::vars(COW_ID))
  pointblank::expect_col_exists(regimes[["FreedomHouse2"]],
                                pointblank::vars(ID))
  expect_true(is.character(regimes[["FreedomHouse2"]][["ID"]]))
  pointblank::expect_col_exists(regimes[["FreedomHouse2"]],
