...
CShapes2.0 <- readr::read_csv("data-raw/distances/CShapes2.0/CShapes-2.0.csv")

# Stage two: Correcting data
# In this stage you will want to correct the variable names and
# formats of the 'CShapes2.0' object until the object created
# below (in stage three) passes all the tests. 
CShapes2.0 <- as_tibble(CShapes2.0) %>%
...
# Next run the following line to make CShapes2.0 available within the qPackage.
export_data(CShapes2.0, database = "distances")
