# FHaggregate Preparation Script

# This is a template for importing, cleaning, and exporting data
# ready for many packages universe.
# The FHaggregate dataset contains Freedom House aggregated category and
# subcategory scores from the 2003-2021 edition.

# Stage one: Collecting data
# Data from edition 2006-2021
FHaggregate.1 <- readxl::read_excel("data-raw/regimes/FHaggregate/Aggregate_Category_and_Subcategory_Scores_FIW_2003-2021.xlsx",
                                    sheet = 2,
                                    na = c("-", "N/A"))
# Data from edition 2003-2005
FHaggregate.2 <- readxl::read_excel("data-raw/regimes/FHaggregate/Aggregate_Category_and_Subcategory_Scores_FIW_2003-2021.xlsx",
                                    sheet = 3,
                                    na = c("N/A", "-"))

# Stage two: Correcting data
# In this stage you will want to correct the variable names and
# formats of the 'FHaggregate' object until the object created
...
FHaggregate.1 <- FHaggregate.1[, 1:19]
FHaggregate.1 <- dplyr::rename(FHaggregate.1,
...
FHaggregate.2 <- dplyr::rename(FHaggregate.2,
                               Label = `Country/Territory`) %>%
  manydata::transmutate(Territory = ifelse(`C/T?` == "t", 1, 0)) %>%
...
FHaggregate <- dplyr::bind_rows(FHaggregate.1, FHaggregate.2) %>%
  dplyr::mutate(
...
# Next run the following line to make FHaggregate available
# within the package.
...
# please run `manypkgs::add_bib("regimes", "FHaggregate")`.
manypkgs::export_data(FHaggregate, database = "regimes",
