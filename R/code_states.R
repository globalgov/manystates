...
england|united.?kingdom|britain|british(?!.*hondur| east africa)|\buk\b|\bu[[:punct:]]k[[:punct:]]\b|royaume-uni",
  ...
  "KLT","Kalat","kalat",
  "KNA","St. Kitts and Nevis","kitts|\bnevis|saint-christophe-et-nieves",
  ...
  "LCA","St. Lucia","\blucia|sainte-lucie",
  ...
  "SIK","Sikkim","sikkim",
  "SIR","Sirohi","sirohi",
  "SLB","Solomon Islands","solomon|iles salomon",
