...
countryRegex <- dplyr::tribble(
  ...
  "KOR","Republic of Korea","(?<!d.p.r. |dpr |democrat |democratic people's republic of |north )korea(?!.*d.p.r|.*dem.*peo.*rep.*)|cor[e]e.*sud|r[e]publique.de.cor[e]e",
  "KOS","Kosovo","kosovo",
  "KOT","Kotah","kotah",
  ...
  "PRK","Democratic People's Republic of Korea","dprk|d.p.r.k|korea.+(d.p.r|dpr|north|dem.*peo.*rep)|(d.p.r|dpr|dem.*peo.*rep.*).+korea|north korea|cor[e]e.*nord",
